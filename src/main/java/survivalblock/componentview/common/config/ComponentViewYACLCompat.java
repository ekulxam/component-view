                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .binding(false, () -> ComponentViewConfig.translateThroughIdentifier, newVal -> ComponentViewConfig.translateThroughIdentifier = newVal)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .binding(false, () -> ComponentViewConfig.removeUnderscoresAndNamespace, newVal -> ComponentViewConfig.removeUnderscoresAndNamespace = newVal)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .binding(true, () -> ComponentViewConfig.showNormallyHiddenComponents, newVal -> ComponentViewConfig.showNormallyHiddenComponents = newVal)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .binding(true, () -> ComponentViewConfig.formatUsingNewlines, newVal -> ComponentViewConfig.formatUsingNewlines = newVal)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .build())
